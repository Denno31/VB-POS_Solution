...
Public Class Report_SaleBySales
    ...
    Private Sub ReportViewer_Load(sender As Object, e As EventArgs) Handles ReportViewer.Load
        ...
        rpt.Load(Directory.GetCurrentDirectory() + "/SaleBySales.rpt")
        ...
        paramField3.ParameterFieldName = "sales_id"
        Dim str3 As String = sales_id
