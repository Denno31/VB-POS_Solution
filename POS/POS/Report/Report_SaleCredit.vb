...
Public Class Report_SaleCredit
    ...
    Private Sub ReportViewer_Load(sender As Object, e As EventArgs) Handles ReportViewer.Load
        ...
        dtMap.Columns.Add(New DataColumn("CREDIT", GetType(String)))
        ...
        For i = 0 To m_dt.Rows.Count - 1
            ...
            dr("CREDIT") = m_dt.Rows(i)("CREDIT").ToString()
        ...
        rpt.Load(Directory.GetCurrentDirectory() + "/Sale_Credit.rpt")
