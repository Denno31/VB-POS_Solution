...
Public Class SaleRankCustomer
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "POS.SaleRankCustomer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSaleRankCustomer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SaleRankCustomer = New SaleRankCustomer()
        rpt.Site = Me.Site
        Return rpt
    End Function
